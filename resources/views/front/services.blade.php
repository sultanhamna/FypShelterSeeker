...
@section('content')
    ...
    <section class="hero-wrap hero-wrap-2 ftco-degree-bg js-fullheight" style="background-image: url('assets/front/images/bg_1.jpg');" data-stellar-background-ratio="0.5">
