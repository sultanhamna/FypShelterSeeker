<div class="form-group mb-3">
    ...
    {!! Form::select('category_id',
        $categories->pluck('category_name', 'id'),
...
<div class="form-group mb-3">
    ...
    {!! Form::select('location_id',
        $locations->pluck('property_location', 'id'),
...
<div class="form-group mb-3">
    ...
    {!! Form::select('status_id',
        $statuses->pluck('property_status', 'id'),
